...
training_data = pd.read_csv('poker-hand-training-true.data', header=None, names=columns)
testing_data = pd.read_csv('poker-hand-testing.data', header=None, names=columns)
